...
function ArticlesForm({
  ...
  const handleAiSubmit = async () => {
    ...
    if (value && value.length > 4000) {
      setAiError(
        "Your articles content is too long for the AI. Please shorten it."
      );
      return;
    }
  ...
  return (
    <div
    className="
      flex flex-col items-center justify-center w-full h-full pt-10
      relative bg-gray-800 rounded px-2 py-2
    "
    style={{
      marginBottom: "-20px",
      marginTop: "-20px",
          ...
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                ...
                >
                  {aiSubmitting ? "Improving... ✨" : "Improve with AI 🌟"}
                </button>
                <button
                  type="button"
      ...
      <div className="w-full max-w-xl">
        <label
          htmlFor=""
          className="block text-3xl font-bold text-black dark:text-white"
        >
          Title:
        </label>
