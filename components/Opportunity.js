...
//   }, [opportunity.opportunity_id]);
  ...
  return (
    <div className="p-4 mb-4 bg-gray-200 dark:bg-gray-900 rounded-md shadow-lg cursor-pointer hover:bg-gray-300 dark:hover:bg-black transition duration-200 ease-in-out">
    <Link href={`/opportunity/${opportunity.opportunity_id}`}>
      ...
      <p className="text-sm text-gray-500">Views: {opportunity.views}</p>
      <p className="text-sm text-gray-500">
