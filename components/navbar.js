    ...
    <>
      <div className="flex md:flex-row items-center justify-between w-full bg-gray-50 dark:bg-gray-900 p-3 sm:py-4 md:p-4 lg:py-5 text-center">
            ...
            {user && (
              <>
                <input
                  ...
                  className="w-full outline-none h-10 border-none px-3 py-2 pl-5 text-sm sm:text-md xl:text-lg font-medium text-gray-700 dark:text-white bg-gray-50 dark:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400 dark:focus:ring-gray-400 transition duration-300 ease-in-out rounded-full "
                />
        ...
        <div className="flex md:hidden">
          <FontAwesomeIcon onClick={()=>setNavHidden(!navhidden)} className="w-auto h-44 md:hidden flex cursor-pointer" icon={faBars}></FontAwesomeIcon>
        </div>
        {/* <svg
