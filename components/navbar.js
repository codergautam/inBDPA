  ...
  return (
    <>
      <div className="flex flex-col md:flex-row items-center justify-between w-full bg-gray-50 dark:bg-gray-900 p-3 sm:py-4 md:p-4 lg:py-5 text-center">
        <div className="md:flex flex gap-96 flex-row md:justify-normal w-full md:w-fit h-min items-center">
          <div className="w-fit">
        ...
        <div className=" relative w-full md:w-72 ml-96 mr-16 lg:w-96 h-10 hidden md:inline">
            {user && (
              <>
                <input
                  type="text"
