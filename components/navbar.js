...
export default function Navbar({ user }) {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between w-full bg-slate-100 dark:bg-gray-900 p-3 sm:py-4 md:p-4 lg:py-5 text-center">
        ...
        {user && user.type === "administrator" && (
          <>
            <Link
              ...
              className="border-1 px-2 py-1 text-md xl:text-lg font-bold text-emerald-500 dark:text-emerald-400 dark:hover:text-white transition duration-400 ease-in-out hover:text-white"
            >
              Admin
            </Link>
          </>
