...
export default function Navbar({ user }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between w-full border-b-2 dark:bg-gray-800 border-black dark:border-gray-600 p-3 lg:p-4 text-center">
      <div className="h-min">
        <Link href="/">
          <img
        ...
        {user && user.type === "administrator" && (
          <>
            <Link
              ...
              className="px-2 py-1 text-xs sm:text-lg font-medium dark:text-gray-200 hover:font-bold transition duration-300 ease-in-out"
            >
              Admin
            </Link>
          </>
        ...
        {user ? (
          <>
            ...
            <Link
              ...
              className="px-2 py-1 text-xs sm:text-lg font-medium hover:font-bold transition duration-300 ease-in-out"
            >
              Logout
            </Link>
            <Link
