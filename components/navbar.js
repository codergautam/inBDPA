...
export default function Navbar({ user }) {
  ...
  return (
    <div className="">
      ...
      <div className="z-50">
        <div className="flex flex-col md:flex-row items-center justify-between w-full bg-gray-50 dark:bg-gray-900 p-3 sm:py-4 md:p-4 lg:py-5 text-center z-50 rounded-b-3xl">
          <div className="items-center md:flex-none flex flex-row justify-between md:justify-normal w-full md:w-fit h-min z-50 ">
      ...
      ></div> */}
          ...
          <div
            className={
              navhidden
                ? "h-min flex flex-col md:flex-row items-center gap-y-1 pb-2 md:gap-y-0 md:pb-0 z-50"
            ...
            {user ? (
              <>
                ...
                <Link
                  ...
                  className="text-sm sm:text-md xl:text-lg font-medium text-gray-200 bg-gray-700 hover:text-black hover:bg-gray-300 dark:text-black dark:bg-gray-200 dark:hover:text-white dark:hover:bg-gray-600 transition duration-300 ease-in-out rounded-full px-4 py-1.5 md:ml-2 ml-0"
                >
                  Profile
                </Link>
              </>
