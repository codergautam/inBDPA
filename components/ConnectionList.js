              ...
              <>
                ...
                >
                  ...
                  <span
                    ...
                    className={
                      user.yourDepth == 1
                        ? `h-fit overflow-visible relative flex items-center gap-6 text-white text-lg font-semibold cursor-pointer rounded-lg bg-gray-100 dark:bg-blue-600 hover:bg-blue-700 dark:hover:bg-blue-700 py-2 mx-auto dark:shadow-2xl duration-200 ease-in-out transition w-full my-2`
                        : user.yourDepth == 2
                        ? `h-fit overflow-visible relative flex items-center gap-6 text-white font-semibold italic flex-row cursor-pointer rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-gray-600 dark:hover:bg-gray-600 my-2 text-lg py-2 mx-auto dark:shadow-2xl duration-200 ease-in-out transition w-full`
                        : `h-fit overflow-visible relative flex items-center gap-6 text-gray-300 font-normal hover:text-white dark:hover:text-white flex-row cursor-pointer rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-gray-600 dark:hover:bg-gray-600 text-sm my-2 py-2 mx-auto dark:shadow-md duration-100 ease-in-out transition w-full`
                    }
                  >
                    {i % 2 === 0 && (
                      <img
