...
export default function Page({
  ...
  return (
    <div className="flex flex-col bg-gray-50 dark:bg-gray-800 min-h-screen h-full w-full">
      <Head>
      ...
      <main className="flex mb-12 pb-4 bg-white border-gray-300 dark:bg-gray-700 border dark:border-gray-700 rounded-2xl w-full text-center">
        <ConnectionList
          ...
          {requestedUser ? (
            <>
              <div className="flex flex-col md:flex-row w-full">
                ...
                <div className="hidden md:flex flex-col p-4 w-full">
                  {user ? (
                    <>
              ...
              <h1 className="text-3xl font-semibold text-gray-900 semism:text-7xl break-all dark:text-white pt-5 w-full">
              ...
              <br />
              <br />
              <button className=" bg-red-600 rounded-full px-4 py-2 hover:bg-red-700 text-black">
                delete profile{" "}
              </button>
            ...
            <>
              <h1 className="text-3xl font-semibold text-gray-900 dark:text-white pt-5 w-full">
