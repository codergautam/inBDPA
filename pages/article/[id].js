// pages/article/[id].js
// This file is responsible for displaying a specific article based on its ID. It imports various components and functions to handle the functionality of viewing and editing an article. The code first imports the necessary dependencies and sets up the necessary state variables. It then defines several functions for updating the article information, deleting the article, and editing the article. The code also includes a useEffect hook to update the views and active viewers of the article every 5 seconds. It also includes a useEffect hook to parse the markdown content of the article. The code then defines the article component which displays the article and includes options to delete or edit the article if the user is the creator. The code also includes a getServerSideProps function which retrieves the necessary article information and session data.
            ...
            <main className="w-5/6 mx-auto mt-6 bg-white dark:bg-gray-800 rounded-lg p-8">
              ...
              <div className="bg-gray-100 dark:bg-gray-700 p-12 rounded-md">
                ...
                <p className="flex text-gray-600 dark:text-gray-100 text-lg w-min min-w-max mx-auto mt-2 space-x-2">
                  ...
                  <span className="inline-flex items-center px-2.5 py-1.5 bg-gray-200 dark:bg-gray-800 text-sm font-medium text-gray-800 dark:text-gray-200 rounded-xl">
                    Active Viewers:{" "}
                    {isNaN(active) ? active : Math.max(active, 1)}
                  </span>
                </p>
